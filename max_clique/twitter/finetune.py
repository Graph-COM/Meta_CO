...
def main():
    ...
    for data in test_loader:
        ...
        vertex_gt = test_data_clique[model_index].clique_number
        gt_output.append(vertex_gt)
        print('model_index:'+str(model_index)+" gt:"+str(vertex_gt)+' model:'+str(model_output[model_index])+" all_node:"+str(data.x.shape[0])+" time:"+str(time_per_data))
